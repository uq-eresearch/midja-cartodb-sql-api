...
module.exports.user_from_host = '^(.*)\\.portal\\.midja\\.org';
module.exports.node_port    = 8080;
module.exports.node_host    = ''; // was 127.0.0.1
// idle socket timeout, in miliseconds
module.exports.node_socket_timeout    = 600000;
module.exports.environment  = 'development';
module.exports.db_base_name = 'cartodb_dev_user_<%= user_id %>_db';
//module.exports.db_base_name='cartodb_dev_user_6917ba11-1bf9-43b7-8929-a0585a8667e6_db';
...
module.exports.redis_host   = 'midja.org';
